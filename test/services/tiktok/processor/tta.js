...
// [QUAN TRỌNG] Đảm bảo đường dẫn import đúng với cấu trúc dự án của bạn
import { processTiktokJob } from '../../../../src/services/tiktok/index.js';
// Bỏ import liên quan đến DB
...
// --- Ví dụ 1: TTA - Campaign Performance ---
const sampleTaskParams_TTA_Campaign = {
  taskType: 'TIKTOK_TTA', // Loại task
  params: {
    endDate: '2025-10-31', 
    startDate: '2025-10-01', 
    accountsToProcess: [
      { id: '7137968211592495105', name: 'HappySkin Vietnam' }, // Thay ID và tên
    ],
    templateName: 'Platform Report by Campaign', // Tên template TTA
    selectedFields: [
  "campaign_id",
  "platform",
  "start_date",
...
const taskToRun = {
    ...
    params: sampleTaskParams_TTA_Campaign.params, // Hoặc sampleTaskParams_BCA_Assets.params
    taskType: sampleTaskParams_TTA_Campaign.taskType // Hoặc sampleTaskParams_BCA_Assets.taskType
};
// --- KẾT THÚC CHỌN TASK ---
